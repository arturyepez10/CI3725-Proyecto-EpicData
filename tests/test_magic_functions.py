...
test_cases.append(lambda :repl.default(r'.load tests\tests_load\t_5.txt'))
test_sol.append(sol1 + sol2)
# -----------------------------------------------------------------------

# ------------------- Dependencia circular ---------------------------------
# Cargarse a si mismo
test_cases.append(lambda :repl.default(r'.load tests\tests_load\t_self.txt'))
test_sol.append([error_circular_dependence('t_self.txt')])

# Archivo que carga una dependecia circular
file_name = "t_6_1.txt"
test_cases.append(lambda :repl.default(r'.load tests\tests_load\\' + file_name))
...
test_cases.append(lambda :repl.default(r'.load tests\tests_load\t_7.txt'))
test_sol.append(sol1 + sol2 + sol1 + sol2 + sol1 + sol2)
#-------------------------------------------------------------------

# --------------- Archivos que contienen errores ------------------
# Archivo con un error de caracter invalido
test_cases.append(lambda :repl.default(r'.load tests\tests_load\t_error_1.txt'))
